...
The **Watchlist** tab aggregates the underlying holdings of every selected ETF. The **# ETFs** column counts how many of the selected ETFs currently hold each ticker, right before the **ETFs** badge column.
